...
void ShadowShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* depthMap[2], Light* light, Light* light2)
{
	...
	XMMATRIX tLight2ViewMatrix = XMMatrixTranspose(light2->getViewMatrix());
	XMMATRIX tLight2ProjectionMatrix = XMMatrixTranspose(light2->getOrthoMatrix());
	...
	lightPtr->direction[0] = XMFLOAT4(light->getDirection().x, light->getDirection().y, light->getDirection().y, 0.0f);
	...
	lightPtr->direction[1] = XMFLOAT4(light2->getDirection().x, light2->getDirection().y, light2->getDirection().y, 0.0f);
